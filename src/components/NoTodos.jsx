      ...
      <svg width="247" height="241" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0)">
          ...
          <path
            ...
            fill="#C7C7C7"
          />
          <path d="M72.522 14.341a4.83 4.83 0 100-9.656 4.83 4.83 0 100 9.656z" fill="#fff" />
          <path
          ...
          <path
            ...
            fill="#C7C7C7"
          />
          <path d="M165.383 44.739a4.645 4.645 0 100-9.288 4.645 4.645 0 100 9.288z" fill="#fff" />
        </g>
        <defs>
          <clipPath id="clip0">
